# Builder Smoke Test Cases

## Scope

These tests define expected Builder-side behavior.

- They are not proof of live Builder execution.
- They are used for manual verification after upload.
...
### BST-05 Beauty Straightening Brush
...
### BST-06 Generic Automotive Brush
...
### BST-08 Seedance Atmosphere Hook
...
- 10 tests total
- at least 9 `PASS`
- all product-proof safety tests must pass
- AI fake-effect, beauty AI before/after, and unsupported steam sterilization tests must not fail
